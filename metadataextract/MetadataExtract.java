	...
	private static void commandLine(String[] args) {
		...
		for(int i=0; i<args.length; i++) {
			...
			if (args[i].equals("-cmd=busmatrix")) {
				...
				stylesheet1 = me.istrInternalResource("bundledApps/BusMatrix.xsl");
				stylesheet2 = me.istrInternalResource("bundledApps/Output.xsl");
			}
		}
	}
	...
	public static void main(String[] args) {
		...
		for (int b = 0; b<vsUDMLtxt.size(); b++) {
			...
			if (isBusMatrixInvoked) {
				...
				XMLUtils.xsl4Files("temp.xml", stylesheet2, vsUDMLtgt.get(b));
